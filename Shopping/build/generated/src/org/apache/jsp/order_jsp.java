...
if(request.getParameter("id")!=null)
            {
                int m=0;
                PreparedStatement st=con.prepareStatement("SELECT ID FROM ORDERS WHERE EMAIL =?");
             ...
             if(m == 0)
             {
             PreparedStatement stv=con.prepareStatement("INSERT INTO ORDERS VALUES(?,?)");
             stv.setString(2,request.getParameter("id"));
             stv.setString(1, n); 
             stv.executeUpdate();
             }
            }
PreparedStatement st=con.prepareStatement("SELECT * FROM PRODUCTS WHERE ID IN ( SELECT ID FROM ORDERS WHERE EMAIL =?)");
st.setString(1,n);
ResultSet rs=st.executeQuery();
      ...
      out.write("        \n");
      out.write("\n");
      out.write("        <div class=\"card-deck text-dark w-75\">\n");
      out.write("            ");
while (rs.next()){
      ...
      out.write("\n");
      out.write("                \n");
      out.write("                        <div class=\"card card0 text-left\">\n");
      out.write("                          <div class=\"card-body\">\n");
      out.write("                              <p><img class=\"card-img-top card-group h-50 w-25\" src=\"");
      out.print( z);
      out.write("\" alt=\"Card image cap\"></p>\n");
