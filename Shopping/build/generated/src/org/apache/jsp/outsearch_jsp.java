...
public final class outsearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
int i=0,l=0;
String n= (String) session.getAttribute("sr");
...
g++;}}
      ...
      out.write("            ");
if(i==0){
            PreparedStatement st1=con.prepareStatement("SELECT * FROM PRODUCTS WHERE ID < 1005"); 
            ResultSet rs1=st1.executeQuery();
      out.write("\n");
      out.write("            <div class=\"text-center\">\n");
      out.write("                \n");
      out.write("              <img src=\"https://i.pinimg.com/originals/20/d3/8b/20d38b1d0d3304dd80adc2e4029278ac.png\" class=\"rounded w-75 h-75\" alt=\"...\">\n");
      out.write("              \n");
      out.write("                \n");
      out.write("            </div>\n");
      ...
      out.write("            ");
while (rs1.next()){
                String z = rs1.getString(2);  
                int nm = rs1.getInt(3);
            
      out.write("\n");
      out.write("            <div class=\"card card0 border-1 h-50\" style=\"width: 15rem\">\n");
      out.write("                <img class=\"card-img-top h-50 \" src=\"");
      out.print( z);
      out.write("\" alt=\"Card image cap\">\n");
      out.write("            <div class=\"card-body\">\n");
      out.write("                <h5 class=\"card-title\"><i class=\"fa fa-inr\" aria-hidden=\"true\"></i> ");
      out.print( nm);
      out.write("</h5>\n");
      out.write("            <div class=\"row\">\n");
      out.write("            <a href=\"#\" class=\"btn btn-secondary\"><i class=\"fa fa-cart-arrow-down\"></i>  Add To Cart</a>&nbsp;\n");
      out.write("            <a href=\"#\" class=\"btn btn-dark\"><i class=\"fa fa-heart-o\"></i>  Wishlist</a>\n");
      out.write("            </div>\n");
      out.write("            </div>\n");
      out.write("            </div>\n");
      out.write("            ");
